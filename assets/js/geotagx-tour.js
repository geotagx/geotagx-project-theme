    ...
    api_.startQuestionnaireTour = function(){
        ...
        var pdf_mode_steps = [
            ...
            },
            {
                ...
                content:"You will be tasked with analysing a PDF Document. When you complete an analysis, a new PDF Document will be presented to you."
            },
            {
                element:".answer button[value='NotClear']",
                onShow:prefix,
                placement:"bottom",
                title:"PDF not clear enough",
                content:"Certain factors may limit how much information you can take away from a PDF. For instance, it is almost impossible to deduce the color of the sky from a black and white photo, or discern a person's facial features from a blurry photo. Select this if you can not answer a question based on what you see in the PDF."
            },
            {
                element:".title",
                onShow:prefix,
                placement:"bottom",
                title:"The Question",
                content:"This is one of many questions asked about the PDF to the left. Try to answer it to the best of your capabilities ..."
            },
            {
                element:".help-toggle",
                onShow:prefix,
            ...
            },
            {
                ...
                placement:"left",
                title:"PDF source",
                content:"... and the PDF source. More often than not, the source will give you contextual information that may prove to be invaluable."
            },
            {
        ...
        var steps_ = window.geotagx_project_template_mode == "image" ? image_mode_steps : pdf_mode_steps;
